<div class="mt-14 pt-5 bg-white">
            ...
            <table id="example" class=" w-full whitespace-nowrap"
                ...
                <thead>
                    <tr class=" h-14 text-sm leading-none text-gray-800 bg-gray-100 hover:bg-gray-100  ">
                        ...
                        <th data-priority="2" class="font-normal text-left pl-12">Titre</th>
                        <th data-priority="3" class=" text-left">Prix</th>
                        <th data-priority="4" class=" text-left">Ville</th>
                        <th data-priority="5" class=" text-left">Disponibilité</th>
    ...
    <x-jet-dialog-modal wire:model="editAnnonce">
        ...
        <x-slot name="content">
            <p class="text-red-500 text-center font-bold">Modifier Article</p>
            @if ($annonceToEdit != null)
                <form
                    ...
                    <div class="grid grid-cols-1 mt-5 mx-7">
                        <label
                            class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold font-mono">Titre
                            Annonce</label>
                        <input
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                        <div class="grid grid-cols-1">
                            <label
                                class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold font-mono">Voiture
                                model</label>
                            <input
                                class="py-2 px-3 rounded-lg border-2 border-red-300 mt-1 focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent"
                        ...
                        <div class="grid grid-cols-1">
                            <label
                                class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold font-mono">Prix</label>
                            <input
                                class="py-2 px-3 rounded-lg border-2 border-red-300 mt-1 focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent"
                    ...
                    <div class="grid grid-cols-1 mt-5 mx-7">
                        ...
                        <select
                            ...
                            <option name="city" value="Paris" @if ($annonceToEdit->city == 'Paris') selected @endif>
                                Paris</option>
                            <option name="city" value="Limoges" @if ($annonceToEdit->city == 'Limoges') selected @endif>
                                Limoges</option>
                            <option name="city" value="Nantes" @if ($annonceToEdit->city == 'Nantes') selected @endif>
                                Nantes</option>
                            <option name="city" value="Lille" @if ($annonceToEdit->city == 'Lille') selected @endif>Lille</option>
                            <option name="city" value="Orleans" @if ($annonceToEdit->city == 'Orleans') selected @endif>
                                Orléans</option>
                            <option name="city" value="Ouazzane" @if ($annonceToEdit->city == 'Nancy') selected @endif>
                                Nancy</option>
                        </select>
                    </div>
                            ...
                            <label for="toogleButton" class="flex items-center cursor-pointer">
                                ...
                                <div class="relative ml-12">
                                    <input id="toogleButton" onClick="hqe.checked = false;hqe1.checked = false;"
                                        type="checkbox" class="hidden" name="premium"></div>
                                    <!-- path -->
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8 mt-5 mx-7">
                        ...
                        <div class="grid grid-cols-1">
                            <label
                                class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold font-mono">De</label>
                        ...
                        <div class="grid grid-cols-1">
                            <label
                                class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold font-mono">A</label>
                        ...
                        <div class="grid grid-cols-1">
                            <label
                                class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold font-mono">D</label>
                    ...
                    <div class="grid grid-cols-1 mx-7">
                        <label
                            class="uppercase mt-12 md:text-sm text-xs text-gray-500 text-light font-semibold -mb-6">Charger
                            Photo</label>
                                    ...
                                    <template x-for="(_,index) in Array.from({ length: files.length })">
                                        <div class="flex flex-row items-center space-x-2">
                                            ...
                                            <span class="font-medium text-gray-500"
                                                x-text="files[index].name">Chargement</span>
                                        </div>
                                    </template>
                                </div>
                            </template>
