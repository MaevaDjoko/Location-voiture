        ...
        <div class="w-full text-white bg-transparent dark-mode:text-gray-200 dark-mode:bg-gray-800">
            <div x-data="{ open: false }"
                ...
                <nav :class="{'flex': open, 'hidden': !open}"
                    ...
                    <a class="px-4 py-2 mt-2 text-md font-semibold bg-transparent rounded-lg md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-white hover:bg-opacity-25 focus:bg-gray-200 focus:outline-none focus:shadow-outline transition delay-100 duration-300 ease-in-out "
                        href="#becomePartner">Devenir partenaire</a>
                    <a class="px-4 py-2 mt-2 text-md font-semibold bg-transparent rounded-lg md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-white hover:bg-opacity-25 focus:bg-gray-200 focus:outline-none focus:shadow-outline transition delay-100 duration-300 ease-in-out "
            ...
            <div>
            <marquee behavior="bottom" direction="top">
                <h3 class="border border-dark pb-2 mb-4 text-center text-white rounded">BIENVENUE SUR NOTRE APPLICATION DE LOCATION DE VOITURES</h3> <br> 
            </marquee>
                    ...
                    <div class="w-full md:w-1/2">
                        <div class="max-w-lg">
                            ...
                            <h1
                                ...
                                Trouvez la voiture dont vous avez besoin
                            </h1>
                ...
                <div class="w-full flex flex-col md:flex-row md:justify-start md:items-center md:pl-20">
                    ...
                    <div class="">
                        <div class="flex flex-col space-y-6 max-w-md mx-auto">
                            <div class="w-full">
                                <p>
                                <p class="text-5xl mt-5 text-gray-600" style="font-family: sweet;">Tu veux te faire</p>
                                <p class="text-5xl mt-5 text-gray-600" style="font-family: sweet;">Beaucoup plus d'argent</p>
                                <p class="text-5xl mt-5 text-gray-600" style="font-family: sweet;">Mets ta voiture</p>
                                <p class="text-5xl mt-5 text-gray-600" style="font-family: sweet;">en location</p>
                                </p>
                            </div>
                            <div>
                                <a href="{{ route('register') }}"
        ...
        <div class="container flex flex-col space-y-32 min-h-screen px-6 py-10 mx-auto md:py-16" id="about">
            ...
            <div class="flex flex-col space-y-6 md:flex-row md:items-center md:space-x-6">
                <div
                    ...
                    <h2 class="text-2xl font-medium tracking-wide text-center text-gray-400 md:text-2xl">Notre mission est de trouver ce dont
                        vous avez besoin
                    </h2>
                </div>
                <div class="w-full md:w-1/2">
                    <div class="max-w-md mx-auto">
                        <p class="mt-5 leading-7 text-gray-600">
                            Vous allez rapidement trouver une voiture. Avec notre réseau de partenaire efficace, il
                            est possible de répondre à vos demandes. <br />
                            Nos partenaires rendent la location de voiture facile pour vous.
                        </p>
            ...
            <div class="w-full min-h-full flex items-center justify-center bg-black pt-5">
                <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
                    <div class="w-full text-7xl font-bold">
                        <h1 class="w-full md:w-2/3">Obtenez nos informations</h1>
                    </div>
                    <div class="flex mt-8 flex-col md:flex-row md:justify-between">
                        <p class="w-full md:w-2/3 text-gray-400">Pour vous assurer que nos annonces vous parviennent. N'oubliez pas de nous noter.</p>
                    ...
                    <div class="flex flex-col">
                        ...
                        <p class="w-full text-center my-12 text-gray-600">Realisé par : Syntiche, Chelsie, Dylan, Cabrel & Saad</p>
                    </div>
                </div>
            </div>
        </footer>
