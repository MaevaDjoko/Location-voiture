    ...
    <div class="flex items-center justify-center py-10">
      <div class="grid bg-black bg-opacity-50 rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
        ...
        <div class="flex justify-center">
          <div class="flex">
            <h1 class="text-white font-bold md:text-2xl text-xl">Creer Annonce</h1>
          </div>
        </div>
        ...
        <form action="/addAnnonce/add" method="post" enctype="multipart/form-data">
          ...
          <div class="grid grid-cols-1 mt-5 mx-7">
            <label class="uppercase md:text-sm text-xs text-white text-light font-semibold font-mono">Titre Annonce</label>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
            <div class="grid grid-cols-1">
              <label class="uppercase md:text-sm text-xs text-white text-light font-semibold font-mono">Modèle voiture</label>
            ...
            <div class="grid grid-cols-1">
              <label class="uppercase md:text-sm text-xs text-white text-light font-semibold font-mono">Prix</label>
          ...
          <div class="grid grid-cols-1 mt-5 mx-7">
            <label class="uppercase md:text-sm text-xs text-white text-light font-semibold font-mono">Ville</label>
            <select class="py-2 px-3 rounded-lg border-2 border-red-300 mt-1 focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent" name="city">
              ...
              <option name="city" value="Limoges">Limoges</option>
              <option name="city" value="Nantes">Nantes</option>
              <option name="city" value="Lille">Lille</option>
              <option name="city" value="Orleans">Orleans</option>
              <option name="city" value="Nancy">Nancy</option>
            </select>
          </div>
          <div class="grid grid-cols-12 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
            ...
            <div class="flex">
              ...
              <div class="px-2 py-4 text-white font-bold"> 7 Jours</div>
              <input type="radio" class="form-radio text-red-600 border-red-500 ml-2 mt-5" value="15" name="days">
              <div class="px-2 py-4 text-white font-bold"> 15 Jours</div>
            </div>
          </div>
          <div class="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8 mt-5 mx-7">
            ...
            <div class="grid grid-cols-1">
              <label class="uppercase md:text-sm text-xs text-white text-light font-semibold font-mono">De</label>
            ...
            <div class="grid grid-cols-1">
              <label class="uppercase md:text-sm text-xs text-white text-light font-semibold font-mono">A</label>
          ...
          <div class="grid grid-cols-1 mx-7">
            <label class="uppercase mt-12 md:text-sm text-xs text-white text-light font-semibold -mb-6">Charger Photo</label>
                ...
                <div class="flex flex-col space-y-1">
                  <template x-for="(_,index) in Array.from({ length: files.length })">
                    <div class="flex flex-row items-center space-x-2">
                      ...
                      <span class="font-medium text-white" x-text="files[index].name">Chargement</span>
                    </div>
                  </template>
                </div>
              </template>
