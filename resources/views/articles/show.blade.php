        ...
        <div class="w-full min-h-full flex items-center justify-center bg-black pt-5">
            <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
                ...
                <div class="flex mt-8 flex-col md:flex-row md:justify-between">
                    <p class="w-full md:w-2/3 text-gray-400">Pour vous assurer que nos annonces vous parviennent. 
                        N'oubliez pas de nous noter.
                    </p>
                    <div class="w-44 pt-6 md:pt-0">
                        <a class="bg-red-500 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center" href="#contact">Contactez-nous</a>
                    </div>
                </div>
